...
if (fa) {
  function calendarJs(elementOrId, options, searchOptions) {
      ...
      if (_options.isWidget) {
        ...
        var firstDay = new Date(
          ...
          startDay = getStartOfWeekDayNumber(
            firstDay.getDay() === 5 ? 7 : firstDay.getDay()
          ),
      ...
      if (_element_Calendar !== null) {
        ...
        if (firstRender && isDefinedString(_options.viewToOpenOnFirstLoad)) {
          if (_options.viewToOpenOnFirstLoad.toLowerCase() === "full-day") {
            ...
            _options.viewToOpenOnFirstLoad.toLowerCase() === "full-week"
          ) {
            showFullWeekView()
          } else if (
            _options.viewToOpenOnFirstLoad.toLowerCase() === "full-year"
          ) {
            showFullYearView()
          } else if (
            _options.viewToOpenOnFirstLoad.toLowerCase() === "timeline"
          ) {
            showTimelineView()
          } else if (
            _options.viewToOpenOnFirstLoad.toLowerCase() === "all-events"
          ) {
            showAllEventsView()
          }
        }
      ...
      if (_element_Calendar === null) {
          ...
          if (element !== null) {
              if (
                  ...
                  // اگر المان یک ورودی تاریخ باشد، اتریبیوت data-jdp را با مقدار تاریخ اضافه می‌کنیم
                  var dateValue = element.value;
                  if (dateValue) {
                      element.setAttribute('data-jdp', dateValue);
                  }
    ...
    function isSideMenuOpen() {
      return (
        _element_SideMenu !== null &&
        _element_SideMenu.className.indexOf("side-menu-open") > -1
      )
    }
    ...
    function buildSideMenuWeekendDays(opened) {
      ...
      if (
        _options.startOfWeekDay === _enum_Day.thursday ||
        _options.startOfWeekDay === _enum_Day.friday
      ) {
      ...
      if (groupsLength > 0) {
        ...
        for (var groupIndex = 0; groupIndex < groupsLength; groupIndex++) {
          ...
          if (isDefined(_options_Configuration.visibleGroups)) {
            visible =
              _options_Configuration.visibleGroups.indexOf(configGroupName) > -1
          }
      ...
      for (var eventType in _options_EventType) {
        if (_options_EventType.hasOwnProperty(eventType)) {
          if (!sectionAndHeaderAdded) {
            ...
            _element_SideMenu_Content_Section_EventTypes_Content =
              createElement("div", "checkbox-container")
    ...
    function updateDatePickerPosition() {
      ...
      if (
        top + _element_Calendar.offsetHeight >
        _parameter_Window.innerHeight
      ) {
        var calendarBorderWidth = parseFloat(
            getStyleValueByName(_element_Calendar, "border-width"),
            10
          ),
          inputBorderWidth = parseFloat(
            getStyleValueByName(_element_Mode_DatePicker_Input, "border-width"),
            10
          )
    ...
    function buildFullDayViewEvent(eventDetails, displayDate) {
      ...
      // بررسی اینکه آیا رویداد قابل مشاهده است و آیا تاریخ آن در لیست تاریخ‌های نادیده گرفته شده نیست
      if (
          isEventVisible(eventDetails) &&
          seriesIgnoreDates.indexOf(formattedDate) === -1
      ) {
          ...
          // اضافه کردن اتریبیوت "data-jdp" به تاریخ موجود
          event.setAttribute("data-jdp", "");
          ...
          if (
              !fireCustomTrigger("onFullDayEventRender", event, eventDetails)
          ) {
              ...
              if (
                  ...
                  if (
                      isDefinedStringAndSet(eventDetails.location)
                  ) {
                  ...
                  if (
                      isDefinedStringAndSet(eventDetails.description)
                  ) {
    ...
    function buildFullWeekViewLayout() {
      var dayNamesHeaderContainer = createElement(
        "div",
    ...
    function buildFullWeekViewDayColumns(weekStartDate, weekEndDate) {
      ...
      while (startWeekDate < weekEndDate) {
        droppableDates[getWeekdayNumber(startWeekDate)] = new Date(
          startWeekDate
        )
    ...
    function buildFullWeekViewTitle(weekStartDate, weekEndDate) {
      ...
      if (
        !fireCustomTrigger("onFullWeekTitleRender", weekStartDate, weekEndDate)
      ) {
    ...
    function buildFullWeekViewEvent(
      ...
      if (
          ...
          event.setAttribute("event-id", eventDetails.id);
          event.setAttribute("event-is-all-day", eventDetails.isAllDay);
          event.setAttribute("data-jdp", ""); // اضافه کردن اتریبیوت "data-jdp" با مقدار تاریخ نمایشی
          ...
          if (
              !fireCustomTrigger("onFullWeekEventRender", event, eventDetails)
          ) {
              var title = createElement("div", "title"),
                  repeatEvery = getNumber(eventDetails.repeatEvery);
          ...
          if (
              !_element_View_FullWeek_EventsShown_PerDay.hasOwnProperty(
                  weekdayNumber
              )
          ) {
    ...
    function showFullWeekView(weekDate, fromOpen) {
      ...
      var actualWeekDate = !isDefined(weekDate)
          ? new Date()
          : new Date(weekDate),
    ...
    function buildDay(
      ...
      if (dayElement !== null) {
        ...
        if (
          ...
          dayElement.className.indexOf("weekend-day") === -1
        ) {
        ...
        if (
          ...
          dayElement.className.indexOf("working-day") === -1
        ) {
    ...
    function buildFullMonthViewDayEvent(dayDate, eventDetails) {
      ...
      if (
        isEventVisible(eventDetails) &&
        seriesIgnoreDates.indexOf(formattedDayDate) === -1
      ) {
    ...
    function buildFullMonthViewDayEventPlusText(elementDay, dayDate) {
      ...
      if (plusXEventsText === null) {
        ...
        var numberOfEvents =
          parseInt(plusXEventsText.getAttribute("events")) + 1
    ...
    function updateDateTotalEventsTracked(formattedNewFromDate, eventId) {
      ...
      if (
        _events_DatesAvailable[formattedNewFromDate].indexOf(eventId) === -1
      ) {
    ...
    function buildFullYearViewMonth(monthIndex) {
      ...
      if (startDay > 1) {
        buildFullYearViewMonthPreviousMonthDays(
          startDay,
          monthDayId,
          monthIndex
        )
    ...
    function buildAllEventsViewEvent(eventDetails) {
      if (isEventVisible(eventDetails)) {
          ...
          event.setAttribute("event-id", eventDetails.id);
          event.setAttribute("event-is-all-day", eventDetails.isAllDay);
          event.setAttribute("data-jdp", ""); // اضافه کردن اتریبیوت "data-jdp" با مقدار تاریخ شروع رویداد
    ...
    function showAllEventsView(fromOpen) {
      ...
      if (_element_View_AllEvents_EventsShown.length === 0) {
        buildNoEventsAvailableText(
          _element_View_AllEvents_Contents,
          function () {
            showEventEditingDialog(null)
          }
        )
    ...
    function buildTimelineViewContentLayout() {
      ...
      while (doDatesMatch(loopDate, loopDateToday)) {
        ...
        if (actualWidth === 0) {
          var borderWidth = getStyleValueByName(
            newColumn1,
            "border-right-width"
          )
    ...
    function buildEventContextMenu() {
      ...
      if (_options.manualEditingEnabled) {
        ...
        _element_ContextMenu_Event_DuplicateSeparator =
    ...
    function showEventContextMenu(e, eventDetails, selectedDate) {
      if (_element_ContextMenu_Event !== null) {
        ...
        _element_ContextMenu_Event_FormattedDateSelected = isDefined(
          selectedDate
        )
          ? selectedDate
          : null
        ...
        if (_events_Selected.length > 1) {
          ...
          if (_options.manualEditingEnabled) {
            ...
            if (url !== _string.empty) {
              _element_ContextMenu_Event_OpenUrlSeparator.style.display =
                "block"
            } else {
              _element_ContextMenu_Event_OpenUrlSeparator.style.display = "none"
            }
          ...
          if (_options.manualEditingEnabled) {
            ...
            _element_ContextMenu_Event_CopySeparator.style.display = "block"
            _element_ContextMenu_Event_Copy.style.display = "block"
            _element_ContextMenu_Event_DuplicateSeparator.style.display =
              "block"
    ...
    function buildFullDayViewContextMenu() {
      ...
      if (_options.manualEditingEnabled) {
        ...
        _element_ContextMenu_FullDay_RemoveEvents =
          buildContextMenuItemWithIcon(
            _element_ContextMenu_FullDay,
            "ib-close-icon",
            _options.removeEventsTooltipText,
        ...
        _element_ContextMenu_FullDay_Paste_Separator =
          buildContextMenuSeparator(_element_ContextMenu_FullDay)
    ...
    function showDayHeaderContextMenu(e, selectedDay) {
      if (!_element_Mode_DatePicker_Enabled) {
        ...
        if (_options.sideMenu.showDays) {
          ...
          var hideDayDisplay =
              _options.visibleDays.length > 1 ? "block" : "none",
    ...
    function buildEventEditorEventTabContent() {
      ...
      _element_Dialog_EventEditor_DateFrom.setAttribute("data-jdp", ""); // اضافه کردن اتریبیوت "data-jdp" به تاریخ شروع
      ...
      _element_Dialog_EventEditor_DateTo.setAttribute("data-jdp", ""); // اضافه کردن اتریبیوت "data-jdp" به تاریخ پایان
    ...
    function buildEventEditorExtraTabContent() {
      ...
      _element_Dialog_EventEditor_Location = createElement(
        "input",
        null,
        "text"
      )
    ...
    function showEventEditingDialog(
      ...
      if (isFunction(_options.onBeforeEventAddEdit)) {
        ...
        if (isDefined(eventDetails)) {
          ...
          _element_Dialog_EventEditor_AddUpdateButton.value =
            _options.updateText
          _element_Dialog_EventEditor_RemoveButton.style.display =
            "inline-block"
          ...
          _element_Dialog_EventEditor_Title.value = getString(
            eventDetails.title
          )
          ...
          _element_Dialog_EventEditor_Group.value = getString(
            eventDetails.group
          )
          ...
          _element_Dialog_EventEditor_RepeatEvery_Custom_Value.value =
            getNumber(eventDetails.repeatEveryCustomValue, 1)
      ...
      if (fromTime.length < 2) {
        ...
        var fromDate = getSelectedDate(_element_Dialog_EventEditor_DateFrom),
          ...
          description = trimString(
            _element_Dialog_EventEditor_Description.value
          ),
            ...
            if (!ignoreFields) {
              var isExistingEvent = isDefined(newId),
                newEvent = {
                  ...
                  type: type,
                  customTags:
                    _element_Dialog_EventEditor_EventDetails.customTags,
    ...
    function buildEventEditingRepeatOptionsDialog() {
      if (
        ...
        _element_Dialog_EventEditor_RepeatOptions_RepeatEnds.setAttribute("data-jdp", "");
    ...
    function buildMessageDialog() {
      if (
        ...
        _element_Dialog_Message = createElement(
          "div",
    ...
    function buildSearchDialog() {
      if (
        ...
        var checkboxOptionsContainer = createElement(
          "div",
          "checkbox-container"
        )
    ...
    function configurationDialogEvent_OK() {
      ...
      _options.organizerName =
        _element_Dialog_Configuration_Organizer_Name.value
    ...
    function isEventVisible(eventDetails) {
      ...
      if (group !== _string.empty) {
        if (isDefined(_options_Configuration.visibleGroups)) {
          visible =
            _options_Configuration.visibleGroups.indexOf(configGroup) > -1
        }
      } else {
    ...
    function buildJumpTpDateDialog() {
      if (
        ...
        _element_Dialog_JumpToDate_Date = createElement("input", null, "data-jdp")
        // _element_Dialog_JumpToDate_Date.setAttribute("data-jdp", "");
    ...
    function buildTooltip() {
      if (_element_Tooltip === null) {
        ...
        _element_Tooltip_Date = createElement("div", "data-jdp")
    ...
    function isViewVisible(element) {
      return (
        isDefined(element) &&
        element.className &&
        element.className.indexOf("view-shown") > -1
      )
    }
    ...
    function turnOnFullScreenMode() {
      if (
        !_element_Calendar_FullScreenModeOn &&
        _options.fullScreenModeEnabled
      ) {
    ...
    function doDatesMatch(date1, date2) {      
      ...
      //shamsi date
      var jdate1 = toJalaali(date1.getFullYear(), date1.getMonth() + 1, date1.getDate());
      var jdate2 = toJalaali(date2.getFullYear(), date2.getMonth() + 1, date2.getDate());
      return (
        jdate1.jd === jdate2.jd &&
        jdate1.jm === jdate2.jm &&
        jdate1.jy === jdate2.jy
    ...
    function isDateToday(date) {
      ...
      //shamsi date
      var jToday = toJalaali(today.getFullYear(), today.getMonth() + 1, today.getDate());
    ...
    function toStorageFormattedDate(date) {
      ...
      var day = ("0" + jDate.jd).slice(-2),
        month = ("0" + jDate.jm).slice(-2),
        formatted = day + "/" + month + "/" + jDate.jy
      return formatted
    }
    ...
    function getWeekdayNumber(date) {
      ...
      //shamsi date
      var jdate = toJalaali(date.getFullYear(), date.getMonth() + 1, date.getDate());
      return jdate.jd - 1 < 0 ? 6 : jdate.jd - 1
    }
    ...
    function getWeekStartEndDates(date) {
      ...
      // } else {
      //   if (_options.startOfWeekDay === _enum_Day.saturday) {
      ...
      // } else if (_options.startOfWeekDay === _enum_Day.thursday) {
      //   date.setDate(date.getDate() - 1)
      // }
      ...
      // محاسبه شروع هفته
      var startOfWeek = new Date(j2d(jdate.jy, jdate.jm, jdate.jd));
      ...
      // تبدیل تاریخ جلالی به فرمت مورد نظر
      var formattedStartDate = formatJalaliDate(jdate.jy, jdate.jm);
      var formattedEndDate = formatJalaliDate(j2d(endOfWeek.getFullYear(), endOfWeek.getMonth() + 1, endOfWeek.getDate()).jy, j2d(endOfWeek.getFullYear(), endOfWeek.getMonth() + 1, endOfWeek.getDate()).jm);
    ...
    function getTotalDaysInMonth(year, month) {
      ...
      var jDate = toJalaali(year, month + 1, 1);
      // محاسبه تعداد روزهای ماه
    ...
    // محاسبه تعداد دقایق گذشته از شروع روز
    ...
    function getWeekNumber(date) {
      ...
      // تبدیل اولین روز سال مورد نظر به تاریخ شمسی جلالی
      var firstDay = new Date(date.getFullYear(), 0, 1);
      var firstDayJalali = toJalaali(firstDay.getFullYear(), firstDay.getMonth() + 1, firstDay.getDate());

      // تبدیل تاریخ ورودی به تاریخ شمسی جلالی
      var jDate = toJalaali(date.getFullYear(), date.getMonth() + 1, date.getDate());
      // محاسبه تعداد روزهای گذشته از اولین روز سال مورد نظر
      var daysPassed = j2d(jDate.jy, jDate.jm, jDate.jd) - j2d(firstDayJalali.jy, firstDayJalali.jm, firstDayJalali.jd);
      // محاسبه شماره هفته
      var weekNumber = Math.ceil((daysPassed + firstDay.getDay() + 1) / 7);
    ...
    // بررسی آیا روز مورد نظر یک روز آخر هفته است یا خیر
    function isWeekendDay(date) {
      // return _options.weekendDays.indexOf(date.getDay()) >= 0

      // تبدیل تاریخ میلادی به تاریخ شمسی جلالی
      var jDate = toJalaali(date.getFullYear(), date.getMonth() + 1, date.getDate());
      var weekendDays = [6, 7]; // جمعه و شنبه به ترتیب
      return weekendDays.includes(j2d(jDate.jy, jDate.jm, jDate.jd));
    }
    ...
    function showDraggingEffect(e, dayElement, areaDate) {
      ...
      if (
        _events_Dragged !== null &&
        dayElement.className.indexOf(" drag-over") === -1 &&
    ...
    function onMoveDocumentMouseMove(e) {
      if (_element_Dialog_Move_IsMoving) {
        _element_Dialog_Move.style.left =
          e.pageX - _element_Dialog_Move_X + "px"
    ...
    function runBrowserNotificationAction(
      action,
      writeConsoleLog,
      eventDetails
    ) {
        ...
        if (isControlKey(e)) {
          if (!isEventIdSelected(eventDetails.id)) {
            ...
            for (
              ...
              if (
                _events_Selected[eventsSelectedIndex].id === eventDetails.id
              ) {
    ...
    function getGroups() {
      ...
      getAllEventsFunc(function (eventDetails) {
        ...
        if (
          group !== _string.empty &&
          groupsAnyCase.indexOf(group.toLowerCase()) === -1
        ) {
          groups.push(group)
    ...
    function getScrollPosition() {
      var doc = _parameter_Document.documentElement,
        left =
          ...
          (doc.clientLeft || 0),
        top =
          (_parameter_Window.pageYOffset || doc.scrollTop) -
          (doc.clientTop || 0)
    ...
    function areArraysTheSame(array1, array2) {
      ...
      if (result) {
        ...
        result =
          _parameter_Json.stringify(array1) ===
          _parameter_Json.stringify(array2)
      }
    ...
    function clearLocalStorageObjects() {
      if (_options.useLocalStorageForEvents && _parameter_Window.localStorage) {
        ...
        for (var keyIndex = 0; keyIndex < keysLength; keyIndex++) {
          if (
            startsWith(_parameter_Window.localStorage.key(keyIndex), "CJS_")
          ) {
    ...
    function importEventsFromICal(file, onLoadEnd) {
      ...
      reader.onload = function (event) {
        ...
        if (
          contentLines[0].indexOf("BEGIN:VCALENDAR") > -1 &&
          contentLines[contentLinesLength - 1].indexOf("END:VCALENDAR") > -1
        ) {
    ...
    function importFromFilesCompleted(eventsAddedOrUpdated) {
      if (eventsAddedOrUpdated.length > 0) {
        ...
        refreshOpenedViews()
        showNotificationPopUp(
          _options.eventsImportedText.replace(
            "{0}",
            eventsAddedOrUpdated.length
          )
        )
    ...
    function getICalContents(orderedEvents) {
      ...
      contents.push(
        "PRODID:-//Bunoon//Calendar.js v" + _this.getVersion() + "//EN"
      )
        ...
        if (
          ...
          contents.push(
            "TRIGGER;VALUE=DATE-TIME:" +
              getICalDateTimeString(orderedEvent.from)
          )
    ...
    this.addEvent = function (
      ...
      if (!_element_Mode_DatePicker_Enabled) {
        setLastUpdated = !isDefinedBoolean(setLastUpdated)
          ? true
          : setLastUpdated
        ...
        if (event.from <= event.to) {
          ...
          if (!_events[storageDate].hasOwnProperty(storageGuid)) {
            ...
            if (
              ...
              !isCustomTriggerSet("onEventsFetch")
            ) {
              var groupName = getGroupName(group)

              if (
                _options_Configuration.visibleGroups.indexOf(groupName) === -1
              ) {
     ...
     * @returns     {boolean}                                               States if the event was updated.
     */
    this.updateEventDateTimes = function (
      id,
      from,
      to,
      repeatEnds,
    ...
    function buildDefaultWorkingHourOptions() {
      var workingHoursStart = getDefaultString(
          _options.workingHoursStart,
          null
        ),
    ...
    function buildDefaulStringOptions() {
      ...
      _options.previousMonthTooltipText = getDefaultString(
        _options.previousMonthTooltipText,
        "Previous Month"
      )
      _options.nextMonthTooltipText = getDefaultString(
        _options.nextMonthTooltipText,
        "Next Month"
      )
      _options.previousDayTooltipText = getDefaultString(
        _options.previousDayTooltipText,
        "Previous Day"
      )
      _options.nextDayTooltipText = getDefaultString(
        _options.nextDayTooltipText,
        "Next Day"
      )
      _options.previousWeekTooltipText = getDefaultString(
        _options.previousWeekTooltipText,
        "Previous Week"
      )
      _options.nextWeekTooltipText = getDefaultString(
        _options.nextWeekTooltipText,
        "Next Week"
      )
      _options.addEventTooltipText = getDefaultString(
        _options.addEventTooltipText,
        "Add Event"
      )
      _options.closeTooltipText = getDefaultString(
        _options.closeTooltipText,
        "Close"
      )
      _options.exportEventsTooltipText = getDefaultString(
        _options.exportEventsTooltipText,
        "Export Events"
      )
      _options.todayTooltipText = getDefaultString(
        _options.todayTooltipText,
        "Today"
      )
      _options.refreshTooltipText = getDefaultString(
        _options.refreshTooltipText,
        "Refresh"
      )
      _options.searchTooltipText = getDefaultString(
        _options.searchTooltipText,
        "Search"
      )
      _options.expandDayTooltipText = getDefaultString(
        _options.expandDayTooltipText,
        "Expand Day"
      )
      _options.viewAllEventsTooltipText = getDefaultString(
        _options.viewAllEventsTooltipText,
        "View All Events"
      )
      _options.viewFullWeekTooltipText = getDefaultString(
        _options.viewFullWeekTooltipText,
        "View Full Week"
      )
      _options.fromText = getDefaultString(_options.fromText, "From:")
      _options.toText = getDefaultString(_options.toText, "To:")
      _options.isAllDayText = getDefaultString(
        _options.isAllDayText,
        "Is All-Day"
      )
      _options.titleText = getDefaultString(_options.titleText, "Title:")
      _options.descriptionText = getDefaultString(
        _options.descriptionText,
        "Description:"
      )
      _options.locationText = getDefaultString(
        _options.locationText,
        "Location:"
      )
      ...
      _options.removeEventText = getDefaultString(
        _options.removeEventText,
        "Remove"
      )
      _options.addEventTitle = getDefaultString(
        _options.addEventTitle,
        "Add Event"
      )
      _options.editEventTitle = getDefaultString(
        _options.editEventTitle,
        "Edit Event"
      )
      _options.exportStartFilename = getDefaultString(
        _options.exportStartFilename,
        "exported_events_"
      )
      _options.fromTimeErrorMessage = getDefaultString(
        _options.fromTimeErrorMessage,
        "Please select a valid 'From' time."
      )
      _options.toTimeErrorMessage = getDefaultString(
        _options.toTimeErrorMessage,
        "Please select a valid 'To' time."
      )
      _options.toSmallerThanFromErrorMessage = getDefaultString(
        _options.toSmallerThanFromErrorMessage,
        "Please select a 'To' date that is larger than the 'From' date."
      )
      _options.titleErrorMessage = getDefaultString(
      ...
      _options.allEventsText = getDefaultString(
        _options.allEventsText,
        "All Events"
      )
      _options.toTimeText = getDefaultString(_options.toTimeText, "to")
      _options.confirmEventRemoveTitle = getDefaultString(
        _options.confirmEventRemoveTitle,
        "Confirm Event Removal"
      )
      _options.confirmEventRemoveMessage = getDefaultString(
        _options.confirmEventRemoveMessage,
        "Removing this event cannot be undone.  Do you want to continue?"
      )
      _options.okText = getDefaultString(_options.okText, "OK")
      _options.exportEventsTitle = getDefaultString(
        _options.exportEventsTitle,
        "Export Events"
      )
      _options.selectColorsText = getDefaultString(
        _options.selectColorsText,
        "Select Colors"
      )
      _options.backgroundColorText = getDefaultString(
        _options.backgroundColorText,
        "Background Color:"
      )
      _options.textColorText = getDefaultString(
        _options.textColorText,
        "Text Color:"
      )
      _options.borderColorText = getDefaultString(
        _options.borderColorText,
        "Border Color:"
      )
      _options.searchEventsTitle = getDefaultString(
        _options.searchEventsTitle,
        "Search Events"
      )
      _options.previousText = getDefaultString(
        _options.previousText,
        "Previous"
      )
      _options.nextText = getDefaultString(_options.nextText, "Next")
      _options.matchCaseText = getDefaultString(
        _options.matchCaseText,
        "Match Case"
      )
      _options.repeatsText = getDefaultString(_options.repeatsText, "Repeats:")
      _options.repeatDaysToExcludeText = getDefaultString(
        _options.repeatDaysToExcludeText,
        "Repeat Days To Exclude:"
      )
      _options.daysToExcludeText = getDefaultString(
        _options.daysToExcludeText,
        "Days To Exclude:"
      )
      _options.seriesIgnoreDatesText = getDefaultString(
        _options.seriesIgnoreDatesText,
        "Series Ignore Dates:"
      )
      _options.repeatsNever = getDefaultString(_options.repeatsNever, "Never")
      _options.repeatsEveryDayText = getDefaultString(
        _options.repeatsEveryDayText,
        "Every Day"
      )
      _options.repeatsEveryWeekText = getDefaultString(
        _options.repeatsEveryWeekText,
        "Every Week"
      )
      _options.repeatsEvery2WeeksText = getDefaultString(
        _options.repeatsEvery2WeeksText,
        "Every 2 Weeks"
      )
      _options.repeatsEveryMonthText = getDefaultString(
        _options.repeatsEveryMonthText,
        "Every Month"
      )
      _options.repeatsEveryYearText = getDefaultString(
        _options.repeatsEveryYearText,
        "Every Year"
      )
      _options.repeatsCustomText = getDefaultString(
        _options.repeatsCustomText,
        "Custom:"
      )
      _options.repeatOptionsTitle = getDefaultString(
        _options.repeatOptionsTitle,
        "Repeat Options"
      )
      ...
      _options.minimizedTooltipText = getDefaultString(
        _options.minimizedTooltipText,
        "Minimize"
      )
      _options.restoreTooltipText = getDefaultString(
        _options.restoreTooltipText,
        "Restore"
      )
      _options.removeAllEventsInSeriesText = getDefaultString(
        _options.removeAllEventsInSeriesText,
        "Remove All Events In Series"
      )
      _options.createdText = getDefaultString(_options.createdText, "Created:")
      _options.organizerNameText = getDefaultString(
        _options.organizerNameText,
        "Organizer:"
      )
      _options.organizerEmailAddressText = getDefaultString(
        _options.organizerEmailAddressText,
        "Organizer Email:"
      )
      _options.enableFullScreenTooltipText = getDefaultString(
        _options.enableFullScreenTooltipText,
        "Turn On Full-Screen Mode"
      )
      _options.disableFullScreenTooltipText = getDefaultString(
        _options.disableFullScreenTooltipText,
        "Turn Off Full-Screen Mode"
      )
      _options.idText = getDefaultString(_options.idText, "ID:")
      _options.expandMonthTooltipText = getDefaultString(
        _options.expandMonthTooltipText,
        "Expand Month"
      )
      _options.repeatEndsText = getDefaultString(
        _options.repeatEndsText,
        "Repeat Ends:"
      )
      _options.noEventsAvailableText = getDefaultString(
        _options.noEventsAvailableText,
        "No events available."
      )
      _options.viewFullWeekText = getDefaultString(
        _options.viewFullWeekText,
        "View Full Week"
      )
      _options.noEventsAvailableFullText = getDefaultString(
      ...
      _options.toAddANewEventText = getDefaultString(
      ...
      _options.configurationTooltipText = getDefaultString(
        _options.configurationTooltipText,
        "Configuration"
      )
      _options.configurationTitleText = getDefaultString(
        _options.configurationTitleText,
        "Configuration"
      )
      _options.groupsText = getDefaultString(_options.groupsText, "Groups")
      _options.eventNotificationTitle = getDefaultString(
        _options.eventNotificationTitle,
        "Calendar.js"
      )
      _options.eventNotificationBody = getDefaultString(
        _options.eventNotificationBody,
        "The event '{0}' has started."
      )
      _options.optionsText = getDefaultString(_options.optionsText, "Options:")
      _options.startsWithText = getDefaultString(
        _options.startsWithText,
        "Starts With"
      )
      _options.endsWithText = getDefaultString(
        _options.endsWithText,
        "Ends With"
      )
      _options.containsText = getDefaultString(
        _options.containsText,
        "Contains"
      )
      _options.displayTabText = getDefaultString(
        _options.displayTabText,
        "Display"
      )
      _options.enableAutoRefreshForEventsText = getDefaultString(
        _options.enableAutoRefreshForEventsText,
        "Enable auto-refresh for events"
      )
      _options.enableBrowserNotificationsText = getDefaultString(
        _options.enableBrowserNotificationsText,
        "Enable browser notifications"
      )
      _options.enableTooltipsText = getDefaultString(
        _options.enableTooltipsText,
        "Enable tooltips"
      )
      ...
      _options.enableDragAndDropForEventText = getDefaultString(
        _options.enableDragAndDropForEventText,
        "Enable drag & drop for events"
      )
      _options.organizerTabText = getDefaultString(
        _options.organizerTabText,
        "Organizer"
      )
      _options.removeEventsTooltipText = getDefaultString(
        _options.removeEventsTooltipText,
        "Remove Events"
      )
      _options.confirmEventsRemoveTitle = getDefaultString(
        _options.confirmEventsRemoveTitle,
        "Confirm Events Removal"
      )
      _options.confirmEventsRemoveMessage = getDefaultString(
        _options.confirmEventsRemoveMessage,
      ...
      _options.optionalText = getDefaultString(
      ...
      _options.thisWeekTooltipText = getDefaultString(
        _options.thisWeekTooltipText,
        "This Week"
      )
      ...
      _options.repeatsByCustomSettingsText = getDefaultString(
        _options.repeatsByCustomSettingsText,
        "By Custom Settings"
      )
      _options.lastUpdatedText = getDefaultString(
        _options.lastUpdatedText,
        "Last Updated:"
      )
      _options.advancedText = getDefaultString(
        _options.advancedText,
        "Advanced"
      )
      _options.copyText = getDefaultString(_options.copyText, "Copy")
      _options.pasteText = getDefaultString(_options.pasteText, "Paste")
      _options.duplicateText = getDefaultString(
        _options.duplicateText,
        "Duplicate"
      )
      _options.showAlertsText = getDefaultString(
        _options.showAlertsText,
        "Show Alerts"
      )
      _options.selectDatePlaceholderText = getDefaultString(
        _options.selectDatePlaceholderText,
        "Select date..."
      )
      _options.hideDayText = getDefaultString(_options.hideDayText, "Hide Day")
      _options.notSearchText = getDefaultString(
        _options.notSearchText,
        "Not (opposite)"
      )
      _options.showHolidaysInTheDisplaysText = getDefaultString(
        _options.showHolidaysInTheDisplaysText,
        "Show holidays in the main display and title bars"
      )
      _options.newEventDefaultTitle = getDefaultString(
        _options.newEventDefaultTitle,
        "* New Event"
      )
      _options.urlErrorMessage = getDefaultString(
        _options.urlErrorMessage,
        "Please enter a valid Url in the 'Url' field (or leave blank)."
      )
      _options.searchTextBoxPlaceholder = getDefaultString(
        _options.searchTextBoxPlaceholder,
        "Search title, description, etc..."
      )
      _options.currentMonthTooltipText = getDefaultString(
        _options.currentMonthTooltipText,
        "Current Month"
      )
      _options.cutText = getDefaultString(_options.cutText, "Cut")
      _options.showMenuTooltipText = getDefaultString(
        _options.showMenuTooltipText,
        "Show Menu"
      )
      _options.eventTypesText = getDefaultString(
        _options.eventTypesText,
        "Event Types"
      )
      _options.lockedText = getDefaultString(_options.lockedText, "Locked:")
      _options.typeText = getDefaultString(_options.typeText, "Type:")
      _options.sideMenuHeaderText = getDefaultString(
        _options.sideMenuHeaderText,
        "Calendar.js"
      )
      _options.sideMenuDaysText = getDefaultString(
        _options.sideMenuDaysText,
        "Days"
      )
      _options.visibleDaysText = getDefaultString(
        _options.visibleDaysText,
        "Visible Days"
      )
      _options.previousYearTooltipText = getDefaultString(
        _options.previousYearTooltipText,
        "Previous Year"
      )
      _options.nextYearTooltipText = getDefaultString(
        _options.nextYearTooltipText,
        "Next Year"
      )
      _options.showOnlyWorkingDaysText = getDefaultString(
        _options.showOnlyWorkingDaysText,
        "Show Only Working Days"
      )
      _options.exportFilenamePlaceholderText = getDefaultString(
        _options.exportFilenamePlaceholderText,
        "Name (optional)"
      )
      ...
      _options.configurationUpdatedText = getDefaultString(
        _options.configurationUpdatedText,
        "Configuration updated."
      )
      _options.eventAddedText = getDefaultString(
        _options.eventAddedText,
        "{0} event added."
      )
      _options.eventUpdatedText = getDefaultString(
        _options.eventUpdatedText,
        "{0} event updated."
      )
      _options.eventRemovedText = getDefaultString(
        _options.eventRemovedText,
        "{0} event removed."
      )
      _options.eventsRemovedText = getDefaultString(
        _options.eventsRemovedText,
        "{0} events removed."
      )
      _options.eventsExportedToText = getDefaultString(
        _options.eventsExportedToText,
        "Events exported to {0}."
      )
      _options.eventsPastedText = getDefaultString(
        _options.eventsPastedText,
        "{0} events pasted."
      )
      _options.eventsExportedText = getDefaultString(
        _options.eventsExportedText,
        "Events exported."
      )
      _options.copyToClipboardOnlyText = getDefaultString(
        _options.copyToClipboardOnlyText,
        "Copy to clipboard only"
      )
      _options.workingDaysText = getDefaultString(
        _options.workingDaysText,
        "Working Days"
      )
      _options.weekendDaysText = getDefaultString(
        _options.weekendDaysText,
        "Weekend Days"
      )
      _options.showAsBusyText = getDefaultString(
        _options.showAsBusyText,
        "Show As Busy"
      )
      _options.selectAllText = getDefaultString(
        _options.selectAllText,
        "Select All"
      )
      _options.selectNoneText = getDefaultString(
        _options.selectNoneText,
        "Select None"
      )
      _options.importEventsTooltipText = getDefaultString(
        _options.importEventsTooltipText,
        "Import Events"
      )
      _options.eventsImportedText = getDefaultString(
        _options.eventsImportedText,
        "{0} events imported."
      )
      _options.viewFullYearTooltipText = getDefaultString(
        _options.viewFullYearTooltipText,
        "View Full Year"
      )
      _options.currentYearTooltipText = getDefaultString(
        _options.currentYearTooltipText,
        "Current Year"
      )
      _options.alertOffsetText = getDefaultString(
        _options.alertOffsetText,
        "Alert Offset (minutes):"
      )
      _options.viewFullDayTooltipText = getDefaultString(
        _options.viewFullDayTooltipText,
        "View Full Day"
      )
      _options.confirmEventUpdateTitle = getDefaultString(
        _options.confirmEventUpdateTitle,
        "Confirm Event Update"
      )
      _options.confirmEventUpdateMessage = getDefaultString(
        _options.confirmEventUpdateMessage,
      ...
      _options.viewTimelineTooltipText = getDefaultString(
        _options.viewTimelineTooltipText,
        "View Timeline"
      )
      _options.nextPropertyTooltipText = getDefaultString(
        _options.nextPropertyTooltipText,
        "Next Property"
      )
      _options.noneText = getDefaultString(_options.noneText, "(none)")
      _options.shareText = getDefaultString(_options.shareText, "Share")
      _options.shareStartFilename = getDefaultString(
        _options.shareStartFilename,
        "shared_events_"
      )
      _options.previousPropertyTooltipText = getDefaultString(
        _options.previousPropertyTooltipText,
        "Previous Property"
      )
      _options.jumpToDateTitle = getDefaultString(
        _options.jumpToDateTitle,
        "Jump To Date"
      )
