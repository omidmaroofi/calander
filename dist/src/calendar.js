...
if (fa) {
  function calendarJs(elementOrId, options, searchOptions) {
    ...
    function buildFullWeekViewDayColumnWorkingHours(column, headerNameIndex) {
      if (
        ...
        if (
          ...
          workingHoursEnd =
            _options.workingHoursEnd[headerNameIndex.toString()];
        } else {
          workingHoursEnd = _options.workingHoursEnd;
        }
      ...
      if (!_element_Mode_DatePicker_Enabled) {
        ...
        getAllEventsFunc(function (eventDetails) {
          ...
          if (yearsHandledForEvents.indexOf(fromYear) === -1) {
            var yearEvents = getElementByID(
              _element_ID_YearSelected + fromYear
            );
            if (
              yearEvents !== null &&
    ...
    function buildFullYearViewMonth(monthIndex) {
      ...
      buildFullYearViewMonthNextMonthDays(
        lastFilledDay,
        monthDayId,
        monthIndex
      );
    ...
    function buildEventContextMenu() {
      ...
      _element_ContextMenu_Event = createElement(
        "div",
    ...
    function buildEventEditingDialog() {
      if (!_element_Mode_DatePicker_Enabled) {
        ...
        _element_Dialog_EventEditor_TitleBar = createElement(
          "div",
          "title-bar"
        );
    ...
    function buildEventEditingColorDialog() {
      if (
        ...
        _parameter_Document.body.appendChild(
          _element_Dialog_EventEditor_Colors
        );
    ...
    function buildExportEventsDialog() {
      if (
        ...
        _element_Dialog_ExportEvents_Options.appendChild(
    ...
    function buildSearchDialog() {
      if (
        ...
        _element_Dialog_Search_MinimizedRestoreButton.onmousedown =
          cancelBubble;
        ...
        function () {
          ...
          if (!storeSearchHistory || searchForTextAddedToHistory) {
            ...
            _options_Search.matchCase =
              _element_Dialog_Search_MatchCase.checked;
    ...
    function getOrderedEvents(events, sortAllDayEvents) {
      ...
      if (sortAllDayEvents) {
        events = events.sort(function (a, b) {
          return (
            getBooleanAsNumber(b.isAllDay) - getBooleanAsNumber(a.isAllDay)
          );
        });
      }
    ...
    function onMoveDocumentMouseMove(e) {
      if (_element_Dialog_Move_IsMoving) {
        ...
        _element_Dialog_Move.style.top =
          e.pageY - _element_Dialog_Move_Y + "px";
      }
    }
    ...
    function onMoveDocumentMouseLeave() {
      if (_element_Dialog_Move_IsMoving) {
        _element_Dialog_Move.style.left =
          _element_Dialog_Move_Original_X + "px";
    ...
    function buildNoEventsAvailableText(container, onClickEvent) {
      ...
      if (_options.manualEditingEnabled) {
        ...
        createSpanElement(
          contents,
          _string.space + _options.toAddANewEventText
        );
      }
    }
    ...
    this.addEvent = function (
      ...
      if (!_element_Mode_DatePicker_Enabled) {
        ...
        if (event.from <= event.to) {
          ...
          if (!_events[storageDate].hasOwnProperty(storageGuid)) {
            updateEvents = !isDefinedBoolean(updateEvents)
              ? true
              : updateEvents;
            triggerEvent = !isDefinedBoolean(triggerEvent)
              ? true
              : triggerEvent;
    ...
    function buildDefaultSearchOptions(newSearchOptions) {
      ...
      _options_Search.enabled = getDefaultBoolean(
        _options_Search.enabled,
        true
      );
